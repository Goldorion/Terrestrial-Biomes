...
public class BlockInit {
    ...
    public static final RegistryObject<Block> BEANS = BLOCKS.register("beans", () ->
            new BeanBlock(Items.BEAN::get, BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().randomTicks().sound(SoundType.CROP)));

    public static final RegistryObject<Block> BLACK_BEANS = BLOCKS.register("black_beans", () ->
            new BeanBlock(Items.BLACK_BEAN::get, BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().randomTicks().sound(SoundType.CROP)));

    public static final RegistryObject<Block> RED_BEANS = BLOCKS.register("red_beans", () ->
            new BeanBlock(Items.RED_BEAN::get, BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().randomTicks().sound(SoundType.CROP)));
}
