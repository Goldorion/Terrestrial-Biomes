package net.golkeb.terrestrial_biomes.containers;
...
public class BackpackContainer extends AbstractContainerMenu {
    ...
    public BackpackContainer(int id, Inventory inv, ItemStack stack) {
        this(ContainerInit.BACKPACK_CONTAINER.get(), id, inv, Backpack.getInventory(stack));
    }

    public BackpackContainer(MenuType<? extends BackpackContainer> containerType, int id, Inventory inv, Container container) {
