...
public class BackpackWindow extends AbstractContainerScreen<BackpackContainer> {

    public static ResourceLocation GUI_TO_RENDER = Keys.BACKPACK_GUI;

    public BackpackWindow(BackpackContainer container, Inventory inv, Component title) {
