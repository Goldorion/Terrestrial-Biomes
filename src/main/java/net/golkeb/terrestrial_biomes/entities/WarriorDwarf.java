...
public class WarriorDwarf extends PathfinderMob {

    public static final EntityDataAccessor<String> WARRIOR_DWARF_TEXTURE = SynchedEntityData.defineId(WarriorDwarf.class, EntityDataSerializers.STRING);

    public WarriorDwarf(EntityType<? extends PathfinderMob> entityType, Level level) {
    ...
    public ResourceLocation getTexture() {
        return TerrestrialBiomes.RL(this.entityData.get(WARRIOR_DWARF_TEXTURE));
    }

    @Override
    protected void defineSynchedData() {
        super.defineSynchedData();
        this.entityData.define(WARRIOR_DWARF_TEXTURE, Keys.WARRIOR_DWARF.getPath());
    }
}
